...
function VisualizerWorkspace({ params, courseId, requestedId }) {
  ...
  const isPhaseExecution = isStackExecution || isPostfixExecution || isDelimiterExecution || isUndoRedoExecution || isQueueExecution || isRoundRobinExecution;
